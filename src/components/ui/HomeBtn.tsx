  ...
  return(       
    <button
     onClick={() => setIsNumberVisible(true)}
        className="relative bg-accent/70 w-[min(400px,100%)] flex flex-col items-center  rounded-full border-2 h-14 font-bold text-2xl overflow-hidden [text-shadow:_1px_1px_0_rgb(5_5_5_)] hover:bg-accent/50 duration-300 shadow-castom"
        >
